...
class QuizScheduleAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (val item = items[position]) {
            ...
            is QuizScheduleItem.QuizItem -> (holder as QuizViewHolder).bind(item.quiz, dateFormat)
        }
    }
    ...
    class QuizViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(quiz: Quiz, dateFormat: SimpleDateFormat) {
            name.text = quiz.name
