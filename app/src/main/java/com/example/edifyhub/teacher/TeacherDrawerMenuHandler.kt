...
class TeacherDrawerMenuHandler(
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        val intent = when (item.itemId) {
            ...
            R.id.nav_schedule -> Intent(context, TeacherQuizScheduleActivity::class.java)
            R.id.nav_payment_details -> Intent(context, TeacherPaymentDetailsActivity::class.java)
