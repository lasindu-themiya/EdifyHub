...
class StudentViewOpenDiscussionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_student_view_open_discussion)

        toolbar = findViewById(R.id.studentToolbar)
        setSupportActionBar(toolbar)
        supportActionBar?.title = "Open Discussions"
        ...
        if (savedInstanceState == null) {
            ...
            val fragment = StudentViewOpenDiscussionFragment().apply {
